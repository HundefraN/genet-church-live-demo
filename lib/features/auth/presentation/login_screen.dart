...
class _LoginScreenState extends State<LoginScreen> with TickerProviderStateMixin {
  ...
  Map<String, String> _getRandomAnnouncement() {
    final announcements = [
      {
        'title': 'Sunday\nService',
        'subtitle': 'Join us this Sunday at 10:00 AM for a special sermon series on Faith and Community. All are welcome to worship together.',
      },
      {
        'title': 'Youth\nConference',
        'subtitle': 'Our annual youth conference is approaching next month. Registration is now open through the church office.',
      },
      {
        'title': 'Community\nOutreach',
        'subtitle': 'Monthly food drive happening this Saturday. Thank you for your continued generosity and community support.',
      },
      {
        'title': 'Bible\nStudy',
        'subtitle': 'New weekly Bible study on the Book of John begins this Wednesday evening at 7:00 PM. Everyone welcome.',
      }
    ];
              ...
              children: [
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return CustomPaint(
                      painter: _ModernBackgroundPainter(backgroundController.value),
                      size: Size.infinite,
                    );
                  },
                ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 20),
                              _buildFeatureIndicator('Data Driven Ministry'), // <-- UPDATED TEXT
                            ],
                          ),
                        ],
                      ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Iconsax.message_question, color: Colors.blue.shade600, size: 20),
...
class _ModernBackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 8; i++) {
      ...
      final centerY = size.height * (0.3 + sin(animationValue * 2 * pi + i) * 0.2);
